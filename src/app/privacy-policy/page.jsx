  ...
  return (
    <div className="min-h-screen bg-[#181818] text-gray-200 px-6 py-12">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-400 mb-6">Updated at June 18th, 2025</p>

        <p className="text-gray-400 mb-4">
          Love restored.AI ("we," "our," or "us") is committed to protecting
          your privacy. This Privacy Policy explains how your personal
          information is collected, used, and disclosed by Love restored.AI.
        </p>

        <p className="text-gray-400 mb-6">
          This Privacy Policy applies to our app, and its associated subdomains
          (collectively, our "Service") alongside our application, Love
          restored.AI. By accessing or using our Service, you signify that you
        ...
        <p className="text-gray-400 mb-1">
          ...
          "us," or "our," it refers to LoveRestored.AI, LLC, (United States),
          that is responsible for your information under this Privacy Policy.
        </p>

        <p className="text-gray-400 mb-1">
          <strong>Country:</strong> where Love restored.AI or the
          owners/founders of Love restored.AI are based, in this case is United
          States
        </p>

        <p className="text-gray-400 mb-1">
          <strong>Customer:</strong> refers to the company, organization or
          person that signs up to use the Love restored.AI Service to manage the
        ...
        <p className="text-gray-400 mb-1">
          ...
          Love restored.AI and use the services.
        </p>
        ...
        <p className="text-gray-400 mb-1">
          ...
          employed by Love restored.AI or are under contract to perform a
        ...
        <p className="text-gray-400 mb-1">
          <strong>Service:</strong> refers to the service provided by Love
          restored.AI as described in the relative terms (if available) and on
          this platform.
        </p>
        ...
        <p className="text-gray-400 mb-4">
          <strong>App/Application:</strong> Love restored.AI app, refers to the
          SOFTWARE PRODUCT identified above.
        </p>

        <p className="text-gray-400 mb-6">
          <strong>You:</strong> a person or entity that is registered with Love
          restored.AI to use the Services.
        </p>
        ...
        <h2 className="text-2xl font-semibold text-white mt-8 mb-3">
          When does Love restored.AI use end user information from third
          parties?
        </h2>
        <p className="text-gray-400 mb-4">
          Love restored.AI will collect End User Data necessary to provide the
          Love restored.AI services to our customers. End users may voluntarily
        ...
        <h2 className="text-2xl font-semibold text-white mt-8 mb-3">
          When does Love restored.AI use customer information from third
          parties?
        </h2>
        <p className="text-gray-400 mb-4">
          ...
          interest in becoming a Love restored.AI customer, we receive
          information from a third party that provides automated fraud detection
          services to Love restored.AI. We also occasionally collect information
        ...
        <p className="text-gray-400 mb-4">
          Love restored.AI will collect personal information that you submit to
        ...
        <p className="text-gray-400 mb-4">
          We keep your information only so long as we need it to provide Love
          restored.AI to you and fulfill the purposes described in this policy.
        ...
        <p className="text-gray-400 mb-4">
          ...
          absolute security of any information you transmit to Love restored.AI
        ...
        <p className="text-gray-400 mb-4">
          Love restored.AI is incorporated in United States. Information
          collected via our app, through direct interactions with you, or from
        ...
        <h2 className="text-2xl font-semibold text-white mt-8 mb-3">
          Is the information collected through the Love restored.AI Service
          secure?
        </h2>
        <p className="text-gray-400 mb-4">
        ...
        <p className="text-gray-400 mb-4">
          ...
          information Love restored.AI collects depend on your relationship with
          Love restored.AI. Personnel may update or correct their information as
        ...
        <p className="text-gray-400 mb-4">
          If you are a Love restored.AI worker or applicant, we collect
        ...
        <p className="text-gray-400 mb-4">
          ...
          of the assets of Love restored.AI or any of its Corporate Affiliates
          (as defined herein), or that portion of Love restored.AI or any of its
        ...
        <p className="text-gray-400 mb-4">
          ...
          Love restored.AI, whether by ownership or otherwise. Any information
        ...
        <p className="text-gray-400 mb-4">
          By using Love restored.AI or contacting us directly, you signify your
          acceptance of this Privacy Policy. If you do not agree to this Privacy
          Policy, you should not engage with our app, or use our services.
        ...
        <p className="text-gray-400 mb-4">
          ...
          it's being used. By using our Love restored.AI, registering an
        ...
        <p className="text-gray-400 mb-4">
          ...
          contain links to other websites not operated or controlled by Love
          restored.AI. We are not responsible for the content, accuracy or
        ...
        <p className="text-gray-400 mb-4">
          ...
          party sites. Love restored.AI does not make any representation as to
        ...
        <p className="text-gray-400 mb-4">
          Advertising keeps Love restored.AI and many of the websites and
        ...
        <p className="text-gray-400 mb-4">
          ...
          Love restored.AI of the third party sites, goods or services. Love
          restored.AI takes no responsibility for the content of any of the ads,
        ...
        <p className="text-gray-400 mb-4">
          ...
          on the app and other online services to make online advertisements
        ...
        <p className="text-gray-400 mb-4">
          Love restored.AI uses "Cookies" to identify the areas of our app that
          ...
          our app correctly or at all. We never place Personally Identifiable
        ...
        <p className="text-gray-400 mb-4">
          ...
          also be aware that you may also lose some saved information (e.g.
          ...
          Disabling a cookie or category of cookie does not delete the cookie
        ...
        <p className="text-gray-400 mb-4">
          You acknowledge and agree that Love restored.AI shall not be
          ...
          decency, quality or any other aspect thereof. Love restored.AI does
        ...
        <p className="text-gray-400 mb-4">
          We and third parties use tracking technologies like cookies and
          similar tools for analytics and advertising purposes. These are
          described above and can often be managed via your browser settings.
        </p>
        ...
        <p className="text-gray-400 mb-4">
          ...
          for security purposes. Google Maps API collects information that is
        ...
        <p className="text-gray-400 mb-4">
          ...
          right thing to do. At Love restored.AI we strongly believe that your
        ...
        <p className="text-gray-400 mb-4">
          ...
          requirements of GDPR. Love restored.AI processes or stores all
